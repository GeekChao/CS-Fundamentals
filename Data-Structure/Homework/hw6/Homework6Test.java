...
public class Homework6Test {
  ...
  private static SimpleBoard test;
  /**
  ...
  public static void main(String[] args) {
    ...
    Entry e = table.find(test);
    System.out.println("Find value of Entry: " + ((Integer)e.value()).intValue());

    //remove
    System.out.println("Remove function................");
    Entry e1 = table.remove(test);
    System.out.println("Remove value of Entry: " + ((Integer)e1.value()).intValue());
    table.showTable();

    //makeEmpty
    System.out.println("makeEmpty function................");
    table.makeEmpty();
    table.showTable();
  }
